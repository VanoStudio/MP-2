...
class FullscreenResponsiveApp(ctk.CTk):
    def __init__(self):
        ...
        def show_login():
            ...
            entry_username.grid(row=0, column=0, columnspan=2, pady=scaled(15))
            entry_password.grid(row=1, column=0, pady=scaled(15), sticky="w")
            eye_button.grid(row=1, column=1, padx=(scaled(10), 0), pady=scaled(15), sticky="e")
            login_google_btn.grid(row=2, column=0, columnspan=2, pady=scaled(15))
            login_btn.grid(row=3, column=0, columnspan=2, pady=scaled(15))
            register_label.grid(row=4, column=0, columnspan=2, pady=scaled(15))
